...
export const SKILLS: CanonicalSkill[] = [
...

  {
    ...
    evidence: "project",
    note: "Multi-domain search engine with a generation and grounding layer on top: six causal context-perturbation conditions testing whether the answer follows the retrieved passages or the model's parametric memory. Previously the largest gap on this site (11 of 21 screened postings ask for it) because the Konan work was retrieval without generation and the GPT-4 projects were generation without retrieval.",
  },
  ...
  { id: "ranking", label: "Ranking & Scoring", category: "NLP & Search", parent: "information-retrieval", aliases: ["ranking", "scoring", "relevance", "reranking", "colbert", "colbertv2", "rrf"], evidence: "experience", note: "Millie's Library: +38% ranking quality via custom scoring logic. ColBERTv2 reranking and RRF fusion in the multi-domain search engine." },
  { id: "semantic-search", label: "Semantic / Vector Search", category: "NLP & Search", parent: "information-retrieval", aliases: ["semantic / vector search", "semantic search", "vector search", "embeddings", "embedding", "faiss", "faiss-hnsw", "hnsw"], evidence: "experience" },
  ...
  {
    id: "statistics",
    label: "Statistical Testing & A/B",
    category: "Data",
    aliases: ["statistical testing", "statistics", "a/b testing", "ab testing", "hypothesis testing", "significance testing"],
    evidence: "project",
    note: "Two-proportion z-test, paired Welch's t-test, Benjamini-Hochberg FDR correction, Cohen's h and d, Wilson score intervals in the multi-domain search engine. Backed by the Statistics and Data Science double major.",
  },
...
export const EXTRA_TAGS: Record<string, string[]> = {
  ...
  "ir-search-engine": [
    "nlp", "information-retrieval", "semantic-search", "ranking", "indexing",
    "rag", "llm", "evaluation", "transformer", "huggingface", "pytorch",
